...
import com.agenda.Tomo;

public class TomoComparator implements Comparator<Tomo> {
    @Override
    public int compare(Tomo t1, Tomo t2) {
        String nombre1 = t1.getNombre();
        String nombre2 = t2.getNombre();
